...
public class BitSet2 implements Cloneable, java.io.Serializable {
  ...
  */
  ...
  public int nextSetBitAnd(final BitSet2 other, final int fromIndex) {
...
//    checkInvariants();
  ...
  public BitSet2 duplicate() {
    if (!sizeIsSticky)
      trimToSize();

    final BitSet2 result = new BitSet2();
  ...
  public void copyTo(final BitSet2 other) {
