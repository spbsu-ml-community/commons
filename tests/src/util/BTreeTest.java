...
import com.spbsu.util.FileUtil;
import com.spbsu.util.converters.Integer2ByteBufferConverter;
import com.spbsu.util.converters.IntegerArray2ByteBufferConverter;
import com.spbsu.util.converters.Long2ByteBufferConverter;
import com.spbsu.util.converters.String2ByteBufferConverter;
...
import com.spbsu.util.persist.pages.LeafPage;
...
public class BTreeTest extends TestCase {
  ...
  protected void tearDown() throws Exception {
    if(testRoot != null) FileUtil.deleteDirectoryWithContents(testRoot);
  }
