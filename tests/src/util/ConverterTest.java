...
import com.spbsu.util.converters.*;
...
public class ConverterTest extends TestCase {
  ...
  public void testStringConverter() {
    ...
    final ByteBuffer buffer = conv.convertFrom(s);
    final String s1 = conv.convertTo(buffer);
    assertEquals(s, s1);
    assertEquals(buffer.limit(), buffer.position());
  }
  ...
  public void testListIntegerConverter() {
    ...
    final ByteBuffer buffer = conv.convertFrom(list);

    final List<Integer> result = conv.convertTo(buffer);
  ...
  public void testListStringConverter() {
    ...
    final List<String> result = conv.convertTo(buffer);
    assertEquals(list.size(), result.size());
